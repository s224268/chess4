...
fun getInitialBoard(): Board {
    ...
    board.board[4][0] = Piece(type = 'K', isWhite = true, value = 900, moveStrategy = ::getKingMoves)   // Black king
...
// White pieces
    ...
    board.board[4][7] = Piece(type = 'K', isWhite = false, value = 900, moveStrategy = ::getKingMoves)    // White king
